...
def read_local_config():
    import configargparse
    _parser = configargparse.get_argument_parser(default_config_files=_default_config_files)
    ...
    _parser.add_argument(f'--models', default='./models', type=str, metavar='PATH')
    _paths = _parser.parse_known_args()[0]
    return _paths
